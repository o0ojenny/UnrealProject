...
void ASkillActor::CreateDecal(const FHitResult& Hit)
{
	...
	case EDecalSpawnType::Floor:
	{
		...
		FHitResult	LineHit;
		bool Collision = GetWorld()->LineTraceSingleByChannel(LineHit,GetActorLocation(),GetActorLocation() + FVector::DownVector * 1000.f,ECollisionChannel::ECC_Visibility,param);
