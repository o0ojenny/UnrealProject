...
ACrunch1::ACrunch1()
{
	...
	mMonsterTableRowName = TEXT("Crunch1");
...
void ACrunch1::BeginPlay()
{
	Super::BeginPlay();
}

void ACrunch1::PossessedBy(AController* NewController)
{
	Super::PossessedBy(NewController);

}

void ACrunch1::UnPossessed()
{
	Super::UnPossessed();
}

void ACrunch1::Attack()
{
